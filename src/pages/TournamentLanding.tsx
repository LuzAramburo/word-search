...
const TournamentLanding = () => {
  ...
  return (
    <div className="text-center min-h-[70vh] flex flex-col items-center justify-center">
      ...
      {/* TODO to uppercase */}
      <input id="tournamentId" type="text" placeholder="Tournament ID" className="input input-md input-bordered w-full max-w-xs" />
      <button className="btn btn-primary rounded-r-full">Join</button>
